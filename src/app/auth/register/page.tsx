  ...
  return (
    <div className="flex flex-col gap-8 w-full animate-fade-in">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-bold tracking-tight m-0">Create an account</h1>
        <p className="text-foreground/70 m-0">Join LaunchFlow and automate your business</p>
      </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="relative flex items-center gap-4 py-2">
          ...
          <span className="text-[10px] font-black uppercase tracking-widest text-foreground/30">Or create with email</span>
          <div className="flex-1 h-px bg-border"></div>
        </div>
      </div>

      <form onSubmit={handleRegister} className="flex flex-col gap-6">
        {error && <div className="p-3 bg-error/10 text-error rounded-md text-sm border border-error/20">{error}</div>}
